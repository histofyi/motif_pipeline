...
def run_pipeline(**kwargs) -> Dict:
    ...
    # pipeline.run_step('7') # Create text descriptions for each allele
    #pipeline.run_step('8') # Cluster motifs
    pipeline.run_step('9') # Create a table representation of the data for use in datasette
